...
public class CursosAction extends ActionSupport{
	...
	private List<CarreraBean> lstMantCarrera;
	...
	public String registrarCurso(){
		...
		mensaje = "El curso "+ bean.getNombre() +" se registr� correctamente";
		listarCursos();
		return "grabo";
	}
	...
	public String deleteCurso(){
		...
		mensaje = "El curso se elimin� correctamente";	
		listarCursos();
		return "grabo";
	}
	...
	public List<CarreraBean> getLstMantCarrera() {
		return lstMantCarrera;
	}

	public void setLstMantCarrera(List<CarreraBean> lstMantCarrera) {
