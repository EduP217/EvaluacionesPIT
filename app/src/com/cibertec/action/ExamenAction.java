...
import com.cibertec.services.ExamenService;
...
public class ExamenAction extends ActionSupport{
	...
	/*private List<CarreraBean> lstCarreraExa;
	...
	public String regPreguntas(){
		...
		for(int i=0;i<cadEnunciado.length;i++){
			...
			PreguntaOpcionDTO opcion;
			for(int a=0;a<4;a++){
				opcion = new PreguntaOpcionDTO();
		...
		sesion.put("fecFinal","");
		sesion.put("numDurac","");
		mensaje="El examen se registr� Correctamente.";
		return "ok";
	}
	...
	public List<CarreraBean> getLstCarreraExa() {
		return lstCarreraExa;
	}

	public void setLstCarreraExa(List<CarreraBean> lstCarreraExa) {
